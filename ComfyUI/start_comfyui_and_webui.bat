...
echo ============================================
echo.
start "ComfyUI-Backend" cmd /k "cd /d "%ROOT_DIR%" && "%VENV_PYTHON%" main.py --listen %COMFY_LISTEN% --port %COMFY_PORT% --disable-auto-launch --enable-assets --enable-cors-header --enable-manager"
